...
If you are developing on the NOVAI network, you need to install a wallet and a development environment.

#### Install a wallet

- [Metamask](https://metamask.io/)

You can also use other EVM wallets. NOVAI has a special Snap though so that you can use MetaMask for both the NOVAI chain and Bitcoin.
...
- Bitcoin Light Client: Learn how to interact with Bitcoin by proving transaction inclusion on NOVAI.
- Use tBTC, wBTC, or other ERC20 Tokens as Fee Tokens on NOVAI: Learn how to use tBTC and wBTC as fee tokens on NOVAI.

### Third-Party Tools on NOVAI
