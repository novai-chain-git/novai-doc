...
Wallets that can be used for both Bitcoin and NOVAI.

### MetaMask with Snaps

#### MetaMask with NOVAI Bitcoin Snap
...
You can use any OP Stack-compatible wallet with NOVAI. We recommend using WalletConnect for managing Dapp-to-wallet connections.
