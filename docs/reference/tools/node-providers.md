...
Follow [Conduit's guide](https://docs.conduit.xyz/guides/run-a-node/op-stack-node) to run your own NOVAI node. Search "NOVAI" on their [Browse rollups page](https://app.conduit.xyz/browse-networks) and click "Run a node" to get started.
